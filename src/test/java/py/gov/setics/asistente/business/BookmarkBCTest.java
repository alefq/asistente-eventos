 ...
 * 
 * TICPY Framework is free software; you can redistribute it and/or modify it
 ...
 * modificarlo bajo los términos de la GNU Lesser General Public Licence versión
 * 3 de la Free Software Foundation.
 * 
 * Este programa es distribuido con la esperanza que sea de utilidad, pero sin
 * NINGUNA GARANTÍA; sin una garantía implícita de ADECUACION a cualquier
 * MERCADO o APLICACION EN PARTICULAR. vea la GNU General Public Licence más
 * detalles.
 * 
 * Usted deberá haber recibido una copia de la GNU Lesser General Public Licence
 * versión 3 "LICENCA.txt", junto con este programa; en caso que no, acceda a
 * <http://www.gnu.org/licenses/> o escriba a la Free Software Foundation (FSF)
...
public class BookmarkBCTest {
	...
	public void testUpdate() {
		...
		List<Bookmark> listaBookmarks = bookmarkBC.findAll();
		Bookmark bookmark2 = listaBookmarks.get(0);
		assertNotNull(listaBookmarks);
		...
		listaBookmarks = bookmarkBC.findAll();
		Bookmark bookmark3 = listaBookmarks.get(0);
