...
/* Create Indexes */
CREATE UNIQUE INDEX UNIQUE_PERMISO ON PERMISO (NOMBRE);
CREATE UNIQUE INDEX UNIQUE_ROL_PERMISO ON ROL_PERMISO (PERMISO_ID, ROL_ID);
CREATE UNIQUE INDEX UNIQUE_USUARIO_ROL ON USUARIO_ROL (USUARIO_ID, ROL_ID);
